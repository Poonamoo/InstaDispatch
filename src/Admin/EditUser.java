 ...
 * @author ADMINISTOR
 */
public class EditUser extends javax.swing.JInternalFrame implements BuildConnection{
    String id="-1";
    ...
    public void setdata(){
        try{
            ...
            Statement stmt = con.createStatement();
            String qry ="select * from customers where cid=" + id + ";";
    ...
    try{
            ...
            con = DriverManager.getConnection(CONNSTRING,USERNAME,PASS);
            Statement stmt = con.createStatement();
            String qry ="insert into customers values(" + idtf.getText() + ","
                    + "'" + nametf.getText() + "',"
                    + "'" + phonetf.getText() + "',"
                    + "'" + addtf.getText() + "',"
                    + "'" + mailtf.getText() + "',"
    ...
    private void removedata(){
        try{
            ...
            con = DriverManager.getConnection(CONNSTRING,USERNAME,PASS);
            Statement stmt = con.createStatement();
            String qry ="delete from customers where cid=(" + id + ");";
            //JOptionPane.showMessageDialog(null,qry);
            stmt.executeUpdate(qry);
            stmt.close();
            con.close();
    ...
    try{
            ...
            String qry ="Update customers set "
                    ...
                    + "cphone1='" + phonetf.getText()+"',"
                    + "caddress='" + addtf.getText() + "',"
                    + "cemail='" + mailtf.getText() + "',"
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(addtf, javax.swing.GroupLayout.PREFERRED_SIZE, 546, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(usertf)
                                            .addComponent(passtf, javax.swing.GroupLayout.PREFERRED_SIZE, 203, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int sel =0;
        sel = JOptionPane.showConfirmDialog(null, "Do You Want To remove User:"+ id);
        if (sel==0){
            id=idtf.getText();
            removedata();}
